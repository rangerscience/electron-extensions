(function() {
    document.body.appendChild(document.createElement('script')).src = 'https://s3.amazonaws.com/BoomerangForGmail/bookmarklet/b4g_bookmarklet.js?v=1';
})();
...
window.addEventListener("message", function(event) {
    ...
    if (event.data.type && (event.data.type == "B4G_TRACK_EVENT")) {
        ...
        chrome.runtime.sendMessage({
            greeting: "respondable_input",
            composeBodyText: event.data.composeBodyText,
