! function t(e, n, r) {
    ...
    2: [function(t, e) {
        ...
        function c(t, e) {
            ...
            if (s(t)) return s(e) ? (t = h.call(t), e = h.call(e), u(t, e)) : !1;
            try {
                var n, r, o = v(t),
                    i = v(e)
            } catch (a) {
        ...
        function f(t, e, n, r) {
            ...
            if (r = (n && n.name ? " (" + n.name + ")." : ".") + (r ? " " + r : "."), t && !o && i(o, n, "Missing expected exception" + r), !t && l(o, n) && i(o, n, "Got unwanted exception" + r), t && o && n && !l(o, n) || !t && o) throw o
        }
        var p = t("util/"),
        ...
        }, p.inherits(m.AssertionError, Error), m.fail = i, m.ok = a, m.equal = function(t, e, n) {
            t != e && i(t, e, n, "==", m.equal)
        ...
        e.exports = n, n.EventEmitter = n, n.prototype._events = void 0, n.prototype._maxListeners = void 0, n.defaultMaxListeners = 10, n.prototype.setMaxListeners = function(t) {
            ...
            if (r(n)) switch (arguments.length) {
                ...
                case 3:
                    ...
                    break;
                default:
                    for (o = arguments.length, u = new Array(o - 1), s = 1; o > s; s++) u[s - 1] = arguments[s];
                    n.apply(this, u)
            } else if (i(n)) {
                for (o = arguments.length, u = new Array(o - 1), s = 1; o > s; s++) u[s - 1] = arguments[s];
                for (c = n.slice(), o = c.length, s = 0; o > s; s++) c[s].apply(this, u)
            } return !0
            ...
            if (this._events || (this._events = {}), this._events.newListener && this.emit("newListener", t, r(e.listener) ? e.listener : e), this._events[t] ? i(this._events[t]) ? this._events[t].push(e) : this._events[t] = [this._events[t], e] : this._events[t] = e, i(this._events[t]) && !this._events[t].warned) {
                var o;
                o = a(this._maxListeners) ? n.defaultMaxListeners : this._maxListeners, o && o > 0 && this._events[t].length > o && (this._events[t].warned = !0, console.error("(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.", this._events[t].length), "function" == typeof console.trace && console.trace())
            }
            return this
    ...
    6: [function(t, e) {
        ...
        e.exports = function(t, e, o, i) {
            ...
            s > 0 && c > s && (c = s);
            for (var l = 0; c > l; ++l) {
                var f, p, h, d, m = t[l].replace(u, "%20"),
                    v = m.indexOf(o);
                v >= 0 ? (f = m.substr(0, v), p = m.substr(v + 1)) : (f = m, p = ""), h = decodeURIComponent(f), d = decodeURIComponent(p), n(a, h) ? r(a[h]) ? a[h].push(d) : a[h] = [a[h], d] : a[h] = d
            }
            return a
        };
    ...
    10: [function(t, e, n) {
        (function(e, r) {
            function o(t, e) {
                ...
                return arguments.length >= 3 && (r.depth = arguments[2]), arguments.length >= 4 && (r.colors = arguments[3]), m(e) ? r.showHidden = e : e && n._extend(r, e), w(r.showHidden) && (r.showHidden = !1), w(r.depth) && (r.depth = 2), w(r.colors) && (r.colors = !1), w(r.customInspect) && (r.customInspect = !0), r.colors && (r.stylize = i), s(r, t, r.depth)
            }
            ...
            function s(t, e, r) {
                if (t.customInspect && e && S(e.inspect) && e.inspect !== n.inspect && (!e.constructor || e.constructor.prototype !== e)) {
                    var o = e.inspect(r, t);
                ...
                var a = Object.keys(e),
                    m = u(a);
                if (t.showHidden && (a = Object.getOwnPropertyNames(e)), j(e) && (a.indexOf("message") >= 0 || a.indexOf("description") >= 0)) return l(e);
                if (0 === a.length) {
                    if (S(e)) {
                        var v = e.name ? ": " + e.name : "";
                    ...
                    if (I(e)) return t.stylize(Date.prototype.toString.call(e), "date");
                    if (j(e)) return l(e)
                }
                var g = "",
                    y = !1,
                ...
                if (E(e) && (g = " " + RegExp.prototype.toString.call(e)), I(e) && (g = " " + Date.prototype.toUTCString.call(e)), j(e) && (g = " " + l(e)), 0 === a.length && (!y || 0 == e.length)) return b[0] + g + b[1];
                if (0 > r) return E(e) ? t.stylize(RegExp.prototype.toString.call(e), "regexp") : t.stylize("[Object]", "special");
                t.seen.push(e);
                var x;
                return x = y ? f(t, e, r, m, a) : a.map(function(n) {
            ...
            function f(t, e, n, r, o) {
                for (var i = [], a = 0, u = e.length; u > a; ++a) i.push(T(e, String(a)) ? p(t, e, n, r, String(a), !0) : "");
            ...
            function p(t, e, n, r, o, i) {
                ...
                if (c = Object.getOwnPropertyDescriptor(e, o) || {
                        value: e[o]
                    }, c.get ? u = c.set ? t.stylize("[Getter/Setter]", "special") : t.stylize("[Getter]", "special") : c.set && (u = t.stylize("[Setter]", "special")), T(r, o) || (a = "[" + o + "]"), u || (t.seen.indexOf(c.value) < 0 ? (u = v(n) ? s(t, c.value, null) : s(t, c.value, n - 1), u.indexOf("\n") > -1 && (u = i ? u.split("\n").map(function(t) {
                        return "  " + t
                    }).join("\n").substr(2) : "\n" + u.split("\n").map(function(t) {
                        return "   " + t
            ...
            n.format = function(t) {
                ...
                for (var n = 1, r = arguments, i = r.length, a = String(t).replace(C, function(t) {
                        if ("%%" === t) return "%";
                        if (n >= i) return t;
                        switch (t) {
                            case "%s":
                    ...
                    }), u = r[n]; i > n; u = r[++n]) a += v(u) || !x(u) ? " " + u : " " + o(u);
                return a
            ...
            n.debuglog = function(t) {
                if (w(N) && (N = e.env.NODE_DEBUG || ""), t = t.toUpperCase(), !A[t])
                ...
                date: "magenta",
                regexp: "red"
            }, n.isArray = d, n.isBoolean = m, n.isNull = v, n.isNullOrUndefined = g, n.isNumber = y, n.isString = _, n.isSymbol = b, n.isUndefined = w, n.isRegExp = E, n.isObject = x, n.isDate = I, n.isError = j, n.isFunction = S, n.isPrimitive = L, n.isBuffer = t("./support/isBuffer");
    ...
    11: [function(t, e, n) {
        (function(t) {
            (function() {
                ...
                function h(t) {
                    var e = t.cache;
                    e && h(e), t.array = t.cache = t.criteria = t.object = t.number = t.string = t.value = null, y.length < E && y.push(t)
                }
                ...
                function m(t) {
                    function e(t) {
                        return t && "object" == typeof t && !Qr(t) && Ar.call(t, "__wrapped__") ? t : new n(t)
                    }
                    ...
                    function g(t, e, n, r, o) {
                        ...
                        switch (u) {
                            ...
                            case K:
                                return new s(t);
                            case B:
                                return i = s(t.source, k.exec(t)), i.lastIndex = t.lastIndex, i
                        }
                        var c = Qr(t);
                        if (e) {
                            var f = !r;
                        ...
                        return c && (Ar.call(t, "index") && (i.index = t.index), Ar.call(t, "input") && (i.input = t.input)), e ? (r.push(t), o.push(i), (c ? Ye : so)(t, function(t, a) {
                            i[a] = g(t, e, n, r, o)
                        }), f && (p(r), p(o)), i) : i
                    }
                    ...
                    function E(t, e, n) {
                        ...
                        if ("undefined" == typeof r && (Yr.funcNames && (r = !t.name), r = r || !Yr.funcDecomp, !r)) {
                            var o = Cr.call(t);
                            Yr.funcNames || (r = !O.test(o)), r || (r = N.test(o), Zr(t, r))
                        }
                    ...
                    function Y(t) {
                        function e() {
                            ...
                            if ((i || l) && (h || (h = d(arguments)), i && Mr.apply(h, i), l && h.length < u)) return r |= 16, Y([n, f ? r : -4 & r, h, null, a, u]);
                            if (h || (h = arguments), c && (n = t[p]), this instanceof e) {
                                t = y(n.prototype);
                                var m = n.apply(t, h);
                                return Re(m) ? m : t
                            }
                    ...
                    function X(t, e, n, r) {
                        for (var o = (r || 0) - 1, i = t ? t.length : 0, a = []; ++o < i;) {
                            var u = t[o];
                            if (u && "object" == typeof u && "number" == typeof u.length && (Qr(u) || pe(u))) {
                                e || (u = X(u, e, n));
                                var s = -1,
                                    c = u.length,
                                    l = a.length;
                    ...
                    function te(t, e, n, r, o, i) {
                        ...
                        if (!h) {
                            ...
                            if (d || m) return te(d ? t.__wrapped__ : t, m ? e.__wrapped__ : e, n, r, o, i);
                            if (c != F) return !1;
                            var v = t.constructor,
                                g = e.constructor;
                            if (v != g && !(Oe(v) && v instanceof v && Oe(g) && g instanceof g) && "constructor" in t && "constructor" in e) return !1
                        }
                        var y = !o;
                        o || (o = l()), i || (i = l());
                        for (var _ = o.length; _--;)
                            if (o[_] == t) return i[_] == e;
                        var b = 0;
                            ...
                            if (_ = t.length, b = e.length, a = b == _, a || r)
                                for (; b--;) {
                                    var w = _,
                                        E = e[b];
                                    if (r)
                                        for (; w-- && !(a = te(t[w], E, n, r, o, i)););
                                    else if (!(a = te(t[b], E, n, r, o, i))) break
                                }
                        } else uo(e, function(e, u, s) {
                            return Ar.call(s, u) ? (b++, a = Ar.call(t, u) && te(t[u], e, n, r, o, i)) : void 0
                        ...
                        (Qr(e) ? Ye : so)(e, function(e, i) {
                            ...
                            if (e && ((u = Qr(e)) || co(e))) {
                                for (var l = r.length; l--;)
                                    ...
                                    var f;
                                    n && (s = n(c, e), (f = "undefined" != typeof s) && (c = s)), f || (c = u ? Qr(c) ? c : [] : co(c) ? c : {}), r.push(e), o.push(c), f || ee(c, e, n, r, o)
                                }
                    ...
                    function oe(t, e, n) {
                        ...
                        for (; ++i < u;) {
                            var v = t[i],
                                g = n ? n(v, i, t) : v;
                            (e ? !i || d[d.length - 1] !== g : a(d, g) < 0) && ((n || f) && d.push(g), c.push(v))
                        }
                    ...
                    function ae(t, e, n, r, o, a) {
                        ...
                        l && !n.length && (e &= -17, l = n = !1), f && !r.length && (e &= -33, f = r = !1);
                        var p = t && t.__bindData__;
                        if (p && p !== !0) return p = d(p), p[2] && (p[2] = d(p[2])), p[3] && (p[3] = d(p[3])), !u || 1 & p[1] || (p[4] = o), !u && 1 & p[1] && (e |= 8), !c || 4 & p[1] || (p[5] = a), l && Mr.apply(p[2] || (p[2] = []), n), f && Pr.apply(p[3] || (p[3] = []), r), p[1] |= e, ae.apply(null, p);
                        var h = 1 == e || 17 === e ? i : Y;
                    ...
                    function le(t) {
                        var e, n;
                        return t && Lr.call(t) == F && (e = t.constructor, !Oe(e) || e instanceof e) ? (uo(t, function(t, e) {
                            n = e
                        }), "undefined" == typeof n || Ar.call(t, n)) : !1
                    }
                    ...
                    function pe(t) {
                        return t && "object" == typeof t && "number" == typeof t.length && Lr.call(t) == V || !1
                    }

                    function he(t, e, n, r) {
                        return "boolean" != typeof e && null != e && (r = n, n = e, e = !1), g(t, e, "function" == typeof n && E(n, r, 1))
                    }
                    ...
                    function ge(t, n, r) {
                        var o;
                        return n = e.createCallback(n, r, 3), _e(t, function(t, e, r) {
                            return n(t, e, r) ? (o = e, !1) : void 0
                        }), o
                    }
                    ...
                    function xe(t) {
                        return t === !0 || t === !1 || t && "object" == typeof t && Lr.call(t) == U || !1
                    }
                    ...
                    function Se(t) {
                        ...
                        var n = Lr.call(t),
                            r = t.length;
                        return n == P || n == K || n == V || n == F && "number" == typeof r && Oe(t.splice) ? !r : (so(t, function() {
                            return e = !1
                        }), e)
                    }
                    ...
                    function Ne(t) {
                        return "number" == typeof t || t && "object" == typeof t && Lr.call(t) == z || !1
                    }
                    ...
                    function Me(t) {
                        return "string" == typeof t || t && "object" == typeof t && Lr.call(t) == K || !1
                    }
                    ...
                    function Pe(t) {
                        var e = arguments,
                            n = 2;
                        if (!Re(t)) return t;
                        if ("number" != typeof e[2] && (n = e.length), n > 3 && "function" == typeof e[n - 2]) var r = E(e[--n - 1], e[n--], 2);
                        else n > 2 && "function" == typeof e[n - 1] && (r = e[--n]);
                        for (var o = d(arguments, 1, n), i = -1, a = l(), u = l(); ++i < n;) ee(t, o[i], r, a, u);
                        return p(a), p(u), t
                    }
                    ...
                    function He(t, n, r) {
                        var o = {};
                        if ("function" != typeof n)
                            for (var i = -1, a = X(arguments, !0, !1, 1), u = Re(t) ? a.length : 0; ++i < u;) {
                                var s = a[i];
                                s in t && (o[s] = t[s])
                            } else n = e.createCallback(n, r, 3), uo(t, function(t, e, r) {
                                n(t, e, r) && (o[e] = t)
                        ...
                        if (null == r)
                            if (i) r = [];
                                ...
                                var a = t && t.constructor,
                                    u = a && a.prototype;
                                r = y(u)
                            } return n && (n = e.createCallback(n, o, 4), (i ? Ye : so)(t, function(t, e, o) {
                            return n(r, t, e, o)
                        })), r
                    }
                    ...
                    function Be(t) {
                        for (var e = arguments, n = -1, r = X(e, !0, !1, 1), o = e[2] && e[2][e[1]] === t ? 1 : r.length, i = dr(o); ++n < o;) i[n] = t[r[n]];
                        return i
                    }
                    ...
                    function Ke(t, e, n) {
                        var r = -1,
                            ...
                            i = t ? t.length : 0,
                            a = !1;
                        return n = (0 > n ? Kr(0, i + n) : n) || 0, Qr(t) ? a = o(t, e, n) > -1 : "number" == typeof i ? a = (Me(t) ? t.indexOf(e, n) : o(t, e, n)) > -1 : so(t, function(t) {
                    ...
                    function Ye(t, e, n) {
                        var r = -1,
                            o = t ? t.length : 0;
                        if (e = e && "undefined" == typeof n ? e : E(e, n, 3), "number" == typeof o)
                            for (; ++r < o && e(t[r], r, t) !== !1;);
                        else so(t, e);
                        return t
                    }
                    ...
                    function Ze(t, e, n) {
                        var r = t ? t.length : 0;
                        if (e = e && "undefined" == typeof n ? e : E(e, n, 3), "number" == typeof r)
                            for (; r-- && e(t[r], r, t) !== !1;);
                        else {
                            var o = to(t);
                    ...
                    function tn(t, n, r) {
                        var o = -1 / 0,
                            i = o;
                        if ("function" != typeof n && r && r[n] === t && (n = null), null == n && Qr(t))
                            for (var u = -1, s = t.length; ++u < s;) {
                                var c = t[u];
                                c > i && (i = c)
                            } else n = null == n && Me(t) ? a : e.createCallback(n, r, 3), Ye(t, function(t, e, r) {
                                var a = n(t, e, r);
                                a > o && (o = a, i = t)
                            });
                        return i
                    ...
                    function rn(t, n, r, o) {
                        var i = arguments.length < 3;
                        return n = e.createCallback(n, o, 4), Ze(t, function(t, e, o) {
                            r = i ? (i = !1, t) : n(r, t, e, o)
                        }), r
                    }

                    function on(t, n, r) {
                        return n = e.createCallback(n, r, 3), We(t, function(t, e, r) {
                            return !n(t, e, r)
                        })
                    }

                    function an(t, e, n) {
                        if (t && "number" != typeof t.length && (t = Fe(t)), null == e || n) return t ? t[re(0, t.length - 1)] : v;
                        var r = un(t);
                    ...
                    function ln(t, n, r) {
                        ...
                        for (i || (n = e.createCallback(n, r, 3)), Ye(t, function(t, e, r) {
                                var a = s[++o] = f();
                                i ? a.criteria = Xe(n, function(e) {
                                    return t[e]
                                }) : (a.criteria = l())[0] = n(t, e, r), a.index = o, a.value = t
                    ...
                    function gn(t, e, n, r) {
                        return "boolean" != typeof e && null != e && (r = n, n = "function" != typeof e && r && r[e] === t ? null : e, e = !1), null != n && (t = Xe(t, n, r)), X(t, e)
                    }
                    ...
                    function bn() {
                        for (var t = [], e = -1, n = arguments.length, i = l(), a = se(), u = a === r, c = l(); ++e < n;) {
                            var f = arguments[e];
                            (Qr(f) || pe(f)) && (t.push(f), i.push(u && f.length >= w && s(e ? t[e] : c)))
                        }
                        var d = t[0],
                            m = -1,
                            v = d ? d.length : 0,
                        ...
                        t: for (; ++m < v;) {
                            ...
                            if (f = d[m], (y ? o(y, f) : a(c, f)) < 0) {
                                for (e = n, (y || c).push(f); --e;)
                                    if (y = i[e], (y ? o(y, f) : a(t[e], f)) < 0) continue t;
                                g.push(f)
                            }
                        }
                        for (; n--;) y = i[n], y && h(y);
                    ...
                    function En(t, e, n) {
                        var r = t ? t.length : 0;
                        for ("number" == typeof n && (r = (0 > n ? Kr(0, r + n) : $r(n, r - 1)) + 1); r--;)
                            if (t[r] === e) return r;
                        return -1
                    }
                    ...
                    function xn(t) {
                        for (var e = arguments, n = 0, r = e.length, o = t ? t.length : 0; ++n < r;)
                            for (var i = -1, a = e[n]; ++i < o;) t[i] === a && (Vr.call(t, i--, 1), o--);
                        return t
                    }

                    function In(t, e, n) {
                        t = +t || 0, n = "number" == typeof n ? n : +n || 1, null == e && (e = t, t = 0);
                        for (var r = -1, o = Kr(0, Or((e - t) / (n || 1))), i = dr(o); ++r < o;) i[r] = t, t += n;
                        return i
                    }
                    ...
                    function Ln(t, n, r, o) {
                        var i = 0,
                            a = t ? t.length : i;
                        for (r = r ? e.createCallback(r, o, 1) : Qn, n = r(n); a > i;) {
                            var u = i + a >>> 1;
                            r(t[u]) < n ? i = u + 1 : a = u
                        }
                        return i
                    ...
                    function Tn() {
                        for (var t = -1, e = arguments.length; ++t < e;) {
                            var n = arguments[t];
                            if (Qr(n) || pe(n)) var r = r ? oe(Q(r, n).concat(Q(n, r))) : n
                        }
                        return r || []
                    }

                    function Cn() {
                        for (var t = arguments.length > 1 ? arguments : arguments[0], e = -1, n = t ? tn(ho(t, "length")) : 0, r = dr(0 > n ? 0 : n); ++e < n;) r[e] = ho(t, e);
                        return r
                    }
                    ...
                    function Dn(t) {
                        for (var e = arguments.length > 1 ? X(arguments, !0, !1, 1) : be(t), n = -1, r = e.length; ++n < r;) {
                            var o = e[n];
                    ...
                    function qn(t, e, n) {
                        ...
                        if (e = Kr(0, e) || 0, n === !0) {
                            var h = !0;
                            p = !1
                        } else Re(n) && (h = n.leading, f = "maxWait" in n && (Kr(e, n.maxWait) || 0), p = "trailing" in n ? n.trailing : p);
                        var d = function() {
                                var n = e - (vo() - a);
                                if (0 >= n) {
                                    o && Rr(o);
                                    var f = c;
                                    o = s = c = v, f && (l = vo(), i = t.apply(u, r), s || o || (r = u = null))
                                } else s = Dr(d, n)
                            },
                            m = function() {
                                s && Rr(s), o = s = c = v, (p || f !== e) && (l = vo(), i = t.apply(u, r), s || o || (r = u = null))
                            };
                        return function() {
                            if (r = arguments, a = vo(), u = this, c = p && (s || !h), f === !1) var n = h && !s;
                            else {
                                o || h || (l = a);
                                var v = f - (a - l),
                                    g = 0 >= v;
                                g ? (o && (o = Rr(o)), l = a, i = t.apply(u, r)) : o || (o = Dr(m, v))
                            }
                            return g && s ? s = Rr(s) : s || e === f || (s = Dr(d, e)), n && (g = !0, i = t.apply(u, r)), !g || s || o || (r = u = null), i
                        }
                    }
                    ...
                    function Fn(t, e) {
                        ...
                        var n = function() {
                            ...
                            return Ar.call(r, o) ? r[o] : r[o] = t.apply(this, arguments)
                        };
                        return n.cache = {}, n
                    }
                    ...
                    function Wn(t, e, n) {
                        var r = !0,
                            o = !0;
                        if (!Oe(t)) throw new xr;
                        return n === !1 ? r = !1 : Re(n) && (r = "leading" in n ? n.leading : r, o = "trailing" in n ? n.trailing : o), W.leading = r, W.maxWait = e, W.trailing = o, qn(t, e, W)
                    }
                    ...
                    function Yn(t, e, n) {
                        ...
                        var o = to(t),
                            i = o[0],
                            a = t[i];
                        return 1 != o.length || a !== a || Re(a) ? function(e) {
                    ...
                    function Xn(t, r, o) {
                        var i = !0,
                            a = r && be(r);
                        r && (o || a.length) || (null == o && (o = r), u = n, r = t, t = e, a = be(r)), o === !1 ? i = !1 : Re(o) && "chain" in o && (i = o.chain);
                        var u = t,
                            s = Oe(u);
                        Ye(a, function(e) {
                            var n = t[e] = r[e];
                    ...
                    function rr(t, e, n) {
                        ...
                        if (null == n && ("boolean" == typeof t && o ? (n = t, t = 1) : o || "boolean" != typeof e || (n = e, o = !0)), r && o && (e = 1), t = +t || 0, o ? (e = t, t = 0) : e = +e || 0, n || t % 1 || e % 1) {
                            var i = Gr();
                            return $r(t + i * (e - t + parseFloat("1e-" + ((i + "").length - 1))), e)
                        }
                        return re(t, e)
                    }
                    ...
                    function ir(t, n, r) {
                        ...
                        var i, a = ao({}, r.imports, o.imports),
                            ...
                            f = r.interpolate || C,
                            p = "__p += '",
                            h = wr((r.escape || C).source + "|" + f.source + "|" + (f === R ? L : C).source + "|" + (r.evaluate || C).source + "|$", "g");
                        t.replace(h, function(e, n, r, o, a, u) {
                            return r || (r = o), p += t.slice(l, u).replace(A, c), n && (p += "' +\n__e(" + n + ") +\n'"), a && (i = !0, p += "';\n" + a + ";\n__p += '"), r && (p += "' +\n((__t = (" + r + ")) == null ? '' : __t) +\n'"), l = u + e.length, e
                        }), p += "';\n";
                        var d = r.variable,
                            m = d;
                    ...
                    var dr = t.Array,
                        ...
                        Sr = t._,
                        Lr = jr.toString,
                        kr = wr("^" + Er(Lr).replace(/[.*+?^${}()|[\]\\]/g, "\\$&").replace(/toString| for [^\]]+/g, ".*?") + "$"),
                        Or = yr.ceil,
                        Rr = t.clearTimeout,
                        Tr = yr.floor,
                        ...
                        Gr = yr.random,
                        Jr = {};
                    Jr[P] = dr, Jr[U] = mr, Jr[q] = vr, Jr[H] = gr, Jr[F] = br, Jr[z] = _r, Jr[B] = wr, Jr[K] = Er, n.prototype = e.prototype;
                    var Yr = e.support = {};
                    Yr.funcDecomp = !ce(t.WinRTError) && N.test(m), Yr.funcNames = "string" == typeof gr.name, e.templateSettings = {
                        escape: /<%-([\s\S]+?)%>/g,
                        evaluate: /<%([\s\S]+?)%>/g,
                        interpolate: R,
                        variable: "",
                    ...
                    var Zr = Ur ? function(t, e) {
                            G.value = e, Ur(t, "__bindData__", G)
                        } : er,
                        Qr = Hr || function(t) {
                            return t && "object" == typeof t && "number" == typeof t.length && Lr.call(t) == P || !1
                        },
                        Xr = function(t) {
                            var e, n = t,
                                r = [];
                        ...
                        io = function(t, e, n) {
                            ...
                            if (s > 3 && "function" == typeof a[s - 2]) var c = E(a[--s - 1], a[s--], 2);
                            else s > 2 && "function" == typeof a[s - 1] && (c = a[--s]);
                            for (; ++u < s;)
                                if (o = a[u], o && J[typeof o])
                                    for (var l = -1, f = J[typeof o] && to(o), p = f ? f.length : 0; ++l < p;) r = f[l], i[r] = c ? c(i[r], o[r]) : o[r];
                            return i
                        },
                        ao = function(t, e, n) {
                            var r, o = t,
                            ...
                            for (var a = arguments, u = 0, s = "number" == typeof n ? 2 : a.length; ++u < s;)
                                if (o = a[u], o && J[typeof o])
                                    for (var c = -1, l = J[typeof o] && to(o), f = l ? l.length : 0; ++c < f;) r = l[c], "undefined" == typeof i[r] && (i[r] = o[r]);
                            return i
                        },
                        uo = function(t, e, n) {
                            var r, o = t,
                        ...
                        so = function(t, e, n) {
                            ...
                            if (!J[typeof o]) return i;
                            e = e && "undefined" == typeof n ? e : E(e, n, 3);
                            for (var a = -1, u = J[typeof o] && to(o), s = u ? u.length : 0; ++a < s;)
                    ...
                    }), e.VERSION = "2.4.1", e.prototype.chain = fr, e.prototype.toString = pr, e.prototype.value = hr, e.prototype.valueOf = hr, Ye(["join", "pop", "shift"], function(t) {
                        var r = Ir[t];
                ...
                var ne = m();
                "function" == typeof define && "object" == typeof define.amd && define.amd ? (Z._ = ne, define(function() {
                    return ne
                })) : Q && X ? te ? (X.exports = ne)._ = ne : Q._ = ne : Z._ = ne
            }).call(this)
    ...
    12: [function(t, e) {
        (function(t) {
            ...
            (function() {
                ...
                function o(t, e) {
                    return "onerror" === t ? void Z.on("error", e) : 2 !== arguments.length ? Z[t] : void(Z[t] = e)
                }
                ...
                function h(t, e) {
                    e._state === ie ? g(t, e._result) : t._state === ae ? y(t, e._result) : _(e, void 0, function(n) {
                        e !== n ? m(t, n) : g(t, n)
                    }, function(e) {
                        y(t, e)
                    })
                ...
                function d(t, e) {
                    if (e.constructor === t.constructor) h(t, e);
                        ...
                        var n = l(e);
                        n === ue ? y(t, ue.error) : void 0 === n ? g(t, e) : a(n) ? p(t, e, n) : g(t, e)
                    }
                }
                ...
                function g(t, e) {
                    t._state === oe && (t._result = e, t._state = ie, 0 === t._subscribers.length ? Z.instrument && re("fulfilled", t) : Z.async(b, t))
                }

                function y(t, e) {
                    t._state === oe && (t._state = ae, t._result = e, Z.async(v, t))
                }

                function _(t, e, n, r) {
                    var o = t._subscribers,
                        i = o.length;
                    t._onerror = null, o[i] = e, o[i + ie] = n, o[i + ae] = r, 0 === i && t._state && Z.async(b, t)
                }

                function b(t) {
                    var e = t._subscribers,
                        n = t._state;
                    if (Z.instrument && re(n === ie ? "fulfilled" : "rejected", t), 0 !== e.length) {
                        for (var r, o, i = t._result, a = 0; a < e.length; a += 3) r = e[a], o = e[a + n], r ? x(n, r, o, i) : o(i);
                ...
                function x(t, e, n, r) {
                    var o, i, u, s, c = a(n);
                    if (c) {
                        if (o = E(n, r), o === se ? (s = !0, i = o.error, o = null) : u = !0, e === o) return void y(e, new TypeError("A promises callback cannot return that same promise."))
                    } else o = r, u = !0;
                    e._state !== oe || (c && u ? m(e, o) : s ? y(e, i) : t === ie ? g(e, o) : t === ae && y(e, o))
                }
                ...
                function S(t, e, n, r) {
                    this._instanceConstructor = t, this.promise = new t(c, r), this._abortOnReject = n, this._validateInput(e) ? (this._input = e, this.length = e.length, this._remaining = e.length, this._init(), 0 === this.length ? g(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(), 0 === this._remaining && g(this.promise, this._result))) : y(this.promise, this._validationError())
                }
                ...
                function O(t, e) {
                    this._id = me++, this._label = e, this._state = void 0, this._result = void 0, this._subscribers = [], Z.instrument && re("created", this), c !== t && (a(t) || L(), this instanceof O || k(), I(this, t))
                }
                ...
                function N(t, e) {
                    for (var n, r, o = {}, i = t.length, a = new Array(i), u = 0; i > u; u++) a[u] = t[u];
                    for (r = 0; r < e.length; r++) n = e[r], o[n] = a[r + 1];
                    return o
                }

                function A(t) {
                    for (var e = t.length, n = new Array(e - 1), r = 1; e > r; r++) n[r - 1] = t[r];
                    return n
                }
                ...
                function P(t) {
                    return t && "object" == typeof t ? t.constructor === ve ? !0 : T(t) : !1
                }
                ...
                var Y = {
                        ...
                        off: function(t, e) {
                            var o, i, a = r(this);
                            return e ? (o = a[t], i = n(o, e), void(-1 !== i && o.splice(i, 1))) : void(a[t] = [])
                        },
                ...
                var X = Q,
                    ...
                    re = function(t, e, n) {
                        1 === ne.push({
                            ...
                            for (var t, e = 0; e < ne.length; e++) t = ne[e], Z.trigger(t.name, t.payload);
                            ne.length = 0
                        }, 50)
                    },
                    oe = void 0,
                ...
                S.prototype._enumerate = function() {
                    for (var t = this.length, e = this.promise, n = this._input, r = 0; e._state === oe && t > r; r++) this._eachEntry(n[r], r)
                }, S.prototype._eachEntry = function(t, e) {
                    var n = this._instanceConstructor;
                    u(t) ? t.constructor === n && t._state !== oe ? (t._onerror = null, this._settledAt(t._state, e, t._result)) : this._willSettleAt(n.resolve(t), e) : (this._remaining--, this._result[e] = this._makeResult(ie, e, t))
                }, S.prototype._settledAt = function(t, e, n) {
                    var r = this.promise;
                    r._state === oe && (this._remaining--, this._abortOnReject && t === ae ? y(r, n) : this._result[e] = this._makeResult(t, e, n)), 0 === this._remaining && g(r, this._result)
                ...
                var le = function(t, e) {
                    ...
                    fe = function(t, e) {
                        ...
                        var o = this,
                            i = new o(c, e);
                        if (!X(t)) return y(i, new TypeError("You must pass an array to race.")), i;
                        for (var a = t.length, u = 0; i._state === oe && a > u; u++) _(o.resolve(t[u]), void 0, n, r);
                        return i
                    },
                    pe = function(t, e) {
                        var n = this;
                    ...
                    me = 0,
                    ve = O;
                O.cast = pe, O.all = le, O.race = fe, O.resolve = pe, O.reject = he, O.prototype = {
                    constructor: O,
                    _guidKey: de,
                    _onerror: function(t) {
                        Z.trigger("error", t)
                    ...
                    then: function(t, e, n) {
                        var r = this,
                            o = r._state;
                        if (o === ie && !t || o === ae && !e) return Z.instrument && re("chained", this, this), this;
                        r._onerror = null;
                ...
                var ge = new R,
                    ...
                    _e = function(t, e) {
                        var n = function() {
                            for (var n, r = this, o = arguments.length, i = new Array(o + 1), a = !1, u = 0; o > u; ++u) {
                                if (n = arguments[u], !a) {
                                    if (a = P(n), a === ye) {
                                        var s = new ve(c);
                            ...
                            var l = new ve(c);
                            return i[o] = function(t, n) {
                                t ? y(l, t) : void 0 === e ? m(l, n) : e === !0 ? m(l, A(arguments)) : X(e) ? m(l, N(arguments, e)) : m(l, n)
                ...
                U.prototype = ee(ce.prototype), U.prototype._superConstructor = ce, U.prototype._makeResult = j, U.prototype._validationError = function() {
                ...
                var we = function(t, e) {
                    ...
                    xe = q;
                q.prototype = ee(ce.prototype), q.prototype._superConstructor = ce, q.prototype._init = function() {
                    this._result = {}
                    ...
                    var t = this.promise,
                        e = this._input,
                        n = [];
                    for (var r in e) t._state === oe && e.hasOwnProperty(r) && n.push({
                        position: r,
                        entry: e[r]
                    });
                    var o = n.length;
                    this._remaining = o;
                    for (var i, a = 0; t._state === oe && o > a; a++) i = n[a], this._eachEntry(i.entry, i.position)
                };
                var Ie = function(t, e) {
                    return new xe(ve, t, e).promise
                };
                H.prototype = ee(xe.prototype), H.prototype._superConstructor = ce, H.prototype._makeResult = j, H.prototype._validationError = function() {
                    return new Error("hashSettled must be called with an object")
                };
                var je, Se = function(t, e) {
                    ...
                    ke = function(t) {
                        var e = {};
                        return e.promise = new ve(function(t, n) {
                            e.resolve = t, e.reject = n
                        }, t), e
                    },
                    Oe = function(t, e, n) {
                        return ve.all(t, n).then(function(t) {
                            if (!a(e)) throw new TypeError("You must pass a function as map's second argument.");
                            for (var r = t.length, o = new Array(r), i = 0; r > i; i++) o[i] = e(t[i]);
                            return ve.all(o, n)
                        })
                    },
                    Re = function(t, e) {
                    ...
                    Ce = function(t, e, n) {
                        return ve.all(t, n).then(function(t) {
                            if (!a(e)) throw new TypeError("You must pass a function as filter's second argument.");
                            for (var r = t.length, o = new Array(r), i = 0; r > i; i++) o[i] = e(t[i]);
                            return ve.all(o, n).then(function(e) {
                                for (var n = new Array(r), o = 0, i = 0; r > i; i++) e[i] && (n[o] = t[i], o++);
                                return n.length = o, n
                            })
                        })
                    },
                    ...
                    Ve = "undefined" != typeof Uint8ClampedArray && "undefined" != typeof importScripts && "undefined" != typeof MessageChannel,
                    Pe = new Array(1e3);
                je = "undefined" != typeof t && "[object process]" === {}.toString.call(t) ? z() : De ? F() : Ve ? B() : K(), Z.async = Ae;
                ...
                "function" == typeof define && define.amd ? define(function() {
                    return He
                }) : "undefined" != typeof e && e.exports ? e.exports = He : "undefined" != typeof this && (this.RSVP = He)
            }).call(this)
    ...
    13: [function(t, e) {
        function n(t) {
            return i(t && "string" == typeof t.url, "URL must be given"), new o.Promise(function(e, n) {
                t.method || (t.method = "GET"), t.data && ("string" != typeof t.data && (t.data = a.stringify(t.data)), "GET" === t.method && (t.url += (/\?/.test(t.url) ? "&" : "?") + t.data, delete t.data));
                var o = new XMLHttpRequest;
                r.extend(o, t.xhrFields), o.onerror = function(e) {
                ...
                }, o.open(t.method, t.url, !0), r.each(t.headers, function(t, e) {
    ...
    14: [function(t, e) {
        function n() {
            ...
            return "string" != typeof t.stack ? t.stack : t.stack.replace(/^([^\n]*\n){2}/, "")
        }
        e.exports = n
    }, {}],
    15: [function(t, e) {
        function n(t, e) {
            ...
            var r = new i.Promise(function(e, r) {
                n.addEventListener("error", function(e) {
                    r(e.error || new Error(e.message || "Load failure: " + t, e.filename, e.lineno, e.column))
        ...
        function r(t, e) {
            return u() ? a({
                ...
                return n(t, !1).then(function() {
                    console.warn("Script " + t + " included without CORS headers. Error logs might be censored by the browser.")
                })
            })
        }
        var o = t("lodash"),
            ...
            a = t("./ajax"),
            u = o.once(function() {
                return "undefined" != typeof chrome && chrome.extension ? !0 : "undefined" != typeof safari && safari.extension ? !0 : !1
            });
        e.exports = r
    }, {
        "./ajax": 13,
    ...
    16: [function(t, e) {
        function n(t) {
            return function(e, n, a) {
                var u = arguments;
                try {
                    if (e instanceof Error && (a = a || n, n = e, e = n.message), n && n.__alreadyLoggedBySDK) return;
                    var s = i(),
                        c = ["Got an error:", e, n];
                    n && n.stack && (c = c.concat(["\n\nOriginal error stack:\n" + n.stack])), a && (c = c.concat(["\n\nError details:", a])), c = c.concat(["\n\nError logged from:", s]), console.error.apply(console, c);
                    var l = {
                        nowStack: s,
                        stuffToLog: c
                    };
        ...
        function r(t, e) {
            console.error("ERROR REPORTING ERROR", t), console.error("ORIGINAL ERROR", e)
        }
        var o = t("rsvp"),
            i = t("./get-stack-trace");
        e.exports = n
    ...
    17: [function(t, e) {
        ...
        n.extend(r.prototype, {
            registerComposeViewHandler: function(t) {
                return this._platformImplementationLoader.registerHandler("Compose", "ComposeView", t)
            },
    ...
    18: [function(t, e) {
        ...
        n.extend(r.prototype, {
            registerThreadViewHandler: function(t) {
                return this._platformImplementationLoader.registerHandler("Conversations", "ThreadView", t)
            },
            registerMessageViewHandler: function(t) {
                return this._platformImplementationLoader.registerHandler("Conversations", "MessageView", t)
            }
        }), e.exports = r
    }, {
        lodash: 11
    ...
    19: [function(t, e) {
        ...
        o.prototype = Object.create(r.prototype), n.extend(o.prototype, {
            registerThreadRowViewHandler: function(t) {
                return this._platformImplementationLoader.registerHandler("Mailbox", "ThreadRowView", t)
            }
        }), e.exports = o
    }, {
        events: 3,
    ...
    20: [function(t, e) {
        var n = t("lodash"),
            r = function(t) {
                this._platformImplementationLoader = t, this._modalViewImplementation = null, this._closeEarly = !1
            };
        n.extend(r.prototype, {
            show: function(t) {
                var e = this;
                this._platformImplementationLoader.load().then(function(n) {
                    e._closeEarly || (e._modalViewImplementation = n.Modal.createModalView(t), e._modalViewImplementation.show())
                })
            },
            close: function() {
                this._modalViewImplementation && !this._closeEarly && this._modalViewImplementation.close(), this._closeEarly = !0
            }
        }), e.exports = r
    }, {
        lodash: 11
    ...
    22: [function(t, e) {
        var n = t("lodash"),
            r = t("events").EventEmitter,
            o = (t("rsvp"), function(t) {
                r.call(this), this._platformImplementation = t, this._removed = !1, this._implementation = null, this._subItems = []
            });
        o.prototype = Object.create(r.prototype), n.extend(o.prototype, {
            addNavItem: function(t) {
                if (this._removed) return console.warn("This nav item is removed so nothing will happen"), new o(this._platformImplementation);
            ...
            remove: function() {
                this._subItems.forEach(function(t) {
                    t.remove()
                }), this._implementation.remove(), this._removed = !0
            },
            isCollapsed: function() {
                return this._removed ? (console.warn("This nav item is removed"), null) : this._implementation.isCollapsed()
            },
    ...
    23: [function(t, e) {
        ...
        n.extend(o.prototype, {
            addNavItem: function(t) {
                var e = new r(this._platformImplementationLoader.getPlatformImplementation(), t),
                    n = this._platformImplementationLoader.getPlatformImplementation().NavMenu.addNavItem(t);
    ...
    24: [function(t, e) {
        ...
        n.extend(r.prototype, {
            ...
            createLink: function(t, e) {
                if (!this._platformImplementationLoader.getPlatformImplementation()) throw new Error("Called before InboxSDK finished loading");
                return this._platformImplementationLoader.getPlatformImplementation().Router.createLink(t, e)
            },
            "goto": function(t, e) {
                if (!this._platformImplementationLoader.getPlatformImplementation()) throw new Error("Called before InboxSDK finished loading");
                return this._platformImplementationLoader.getPlatformImplementation().Router.goto(t, e)
            },
            registerRouteViewHandler: function(t) {
                return this._platformImplementationLoader.registerHandler("Router", "RouteView", t)
            },
    ...
    25: [function(t, e) {
        ...
        n.extend(r.prototype, {
            registerThreadSidebarViewHandler: function(t) {
                return this._platformImplementationLoader.registerHandler("Sidebar", "ThreadSidebarView", t)
            },
            registerMessageSidebarViewHandler: function(t) {
                return this._platformImplementationLoader.registerHandler("Sidebar", "MessageSidebarView", t)
            }
        }), e.exports = r
    }, {
        lodash: 11
    ...
    27: [function(t, e) {
        function n(t) {
            if (!t.TEMPORARY_INTERNAL_skipWeakMapRequirement && "undefined" == typeof WeakMap) throw new Error("Browser does not support WeakMap")
        }
        e.exports = n
    }, {}],
    28: [function(t, e) {
        var n = t("lodash"),
            ...
            m = function(e, r) {
                ...
                console.warn("Deprecation warning: Use InboxSDK.load(...) instead."), r = n.extend({
                    globalErrorLogging: !0
                }, r, {
                    VERSION: m.LOADER_VERSION
                }), i(r), this._appId = e, this._platformImplementationLoader = new o(this._appId, r), this._tracker = new f(this._platformImplementationLoader, r), this.Compose = new a(this._platformImplementationLoader), this.Conversations = new u(this._platformImplementationLoader), this.Router = new p(this._platformImplementationLoader), this.FullscreenViews = this.Router, this.Mailbox = new s(this._platformImplementationLoader), this.Modal = new d(this._platformImplementationLoader), this.NavMenu = new c(this._platformImplementationLoader), this.Sidebar = new l(this._platformImplementationLoader), this.Toolbars = new h(this._platformImplementationLoader), this.Util = {
                ...
                this._platformImplementationLoader.load().then(function(t) {
                    m.IMPL_VERSION = m.prototype.IMPL_VERSION = t.IMPL_VERSION
                }).catch(function(t) {
                    console.error("Failed to load implementation:", t)
                })
            };
        m.LOADER_VERSION = "0.7.6-612213e7ed499c62", m.load = function(t, e, a) {
            a = n.extend({
                globalErrorLogging: !0
            }, a, {
                VERSION: m.LOADER_VERSION,
                REQUESTED_API_VERSION: t
            }), r._errorHandlerSetup || (r._errorHandlerSetup = !0, r.on("error", function(t) {
        ...
        }, m.loadScript = t("../common/load-script"), e.exports = m
    }, {
        ...
        (function(n) {
                ...
                i = function(t, e) {
                    ...
                    this.load = o.once(function() {
                        return r.resolve().then(function() {
                            return n.__InboxSDKImpLoader ? void 0 : i._loadScript().then(function() {
                                if (!n.__InboxSDKImpLoader) throw new Error("Implementation file did not load correctly")
                            })
                        }).then(function() {
                            return i._platformImplementation = n.__InboxSDKImpLoader.load("0.1", t, e), i._platformImplementation
                        })
                    })
                };
            o.extend(i.prototype, {
                _loadScript: function() {
                    ...
                    return e("https://www.inboxsdk.com/build/platform-implementation.js")
                },
                registerHandler: function(t, e, n) {
                    var r = null,
                        o = !1;
                    return this.load().then(function(i) {
    ...
    30: [function(t, e) {
        function n(t) {
            ...
            this._platformImplementationLoader = t, this.logError = i(e), r._errorHandlerSetup || (r._errorHandlerSetup = !0, r.on("error", function(t) {
                setTimeout(function() {
                    throw t
                }, 1)
            }))
        ...
        n.prototype.track = function(t, e) {
            if (o.equal(typeof t, "string", "eventName must be a string"), e && (o.equal(typeof e, "object", "details must be an object"), JSON.stringify(e)), arguments.length > 2) throw new Error("Too many parameters");
            this._platformImplementationLoader.load().then(function(n) {
                n.Utils.track(t, e)
            })
        }, e.exports = n
    }, {
        "../common/log-error-factory": 16,
        assert: 2,
        rsvp: 12
    }]
}, {}, [1]);