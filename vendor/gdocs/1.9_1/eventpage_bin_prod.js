...
console.log("################## vendor'd gdocs offline ##################")
...
try {
    ...
    function rb() {
        ...
        console.log("rb, tryna do something with window, window.postMessage, window.addEventListener", window, window.postMessage, window.addEventListener);
        "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && -1 == Wa.indexOf("Presto") && (a = function() {
            ...
            e.open();
            e.write(hb());
            console.log("func rb closing e", e)
            e.close();
    ...
    function bc() {
        return cc(chrome.storage.local, ["offlineOptedIn"]).then(function(a) {
            console.log("################ got from storage offlineOptedIn", a)
            a = a.offlineOptedIn;
            switch (a) {
                case void 0:
                    console.log("offlineOptedIn", "unknown")
                    return "unknown";
                case !0:
                    console.log("offlineOptedIn", "opted in")
                    return "opted_in";
                case !1:
                    console.log("offlineOptedIn", "opted out")
                    return "opted_out";
                default:
                    console.log("offlineOptedIn", "error")
    ...
    function dc(a) {
        return new D(function(b, c) {
            chrome.storage.local.set(a, function() {
                console.log("storage local set", a, chrome.runtime.lastError)
    ...
    function ec(a) {
        ...
        console.log("ec, done something with window.location.href", b);
    ...
    function Pc(a, b) {
        var c = sa("window"),
            d = c[b];
        console.log("Pc, tryna do something with window", c);
        c[b] = function(e, f) {
    ...
    Kc.prototype.D = function() {
        ...
        console.log("Kc.prototype.D, tryna do something with window", a, a.setTimeout)
        var b = a.setTimeout;
        b = b[Mc(this, !1)] || b;
        a.setTimeout = b;
        b = a.setInterval;
    ...
    n.send = function(a, b, c, d) {
        ...
        console.log("making some call", this, a)
        try {
    ...
    function Pd(a, b, c) {
        ...
        if (!c) {
            ...
            console.log("Ps, tryna do something with window", b)
    ...
    function sf() {
        this.a = function() {
            ...
            console.log("sf#a, tryna do something with window", w, w.window);
            var a = w.window;
            a.onbeforeunload = x;
            a.location.reload()
        }
    ...
    */
    ...
    n.ia = function(a) {
        console.log("n.ia, tryna do something with window", window.confirm, a);
        var b = a.b.severity;
    ...
    function Kg(a, b) {
        ...
        a.g = wd(function() {
            ...
            console.log("in Kg closing on w; a.g", w)
            w.close() // HERE 1 / IS THE CLOSE
        }, 3E4)
    }
    n.ma = function(a) {
        var b = a.b;
    ...
    function Qg(a, b) {
        return a.A.b.then(A(function(c) {
            ...
            return Qb(new D(function(e) {
                ...
                console.log("in Qg, closing on d.port1", d.port1)
                d.port1.close()
            })
        }, a))
    }
    ...
    //         console.log(this, arguments[0]); // Here you can do whatever actions you want
    ...
    console.log("gdocs extension error", error)
}

// https://docs.google.com/jserror?jobset=prod&script=https://docs.google.com/Foffline/FextensionFframe%3Fouid%3D&error=Failed to read the  'localStorage ' property from  'Window': Access is denied for this document.&line=Not available
//