...
function storeAndResolveTimingEvents(e, t) {
    ...
    else if (t.timestamp || (t.timestamp = Date.now()), t.allowReporting || (t.allowReporting = !1), null == eventStore[e] && (eventStore[e] = []), "stop" === t.action ? (eventStore[e].push(t), n = resolveTimingStoreToParams(eventStore[e]), eventStore[e] = []) : ("start" == t.action && (eventStore[e] = []), eventStore[e].push(t)), n) {
        var o = {
            action: e
        };
