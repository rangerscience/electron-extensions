...
InviteFriendsDialog.prototype = Object.create(Dialog.prototype), (InviteFriendsDialog.prototype.constructor = InviteFriendsDialog).prototype.setup = function(t, e) {
    if (Dialog.prototype.setup.apply(this, arguments), e.emails) {
        for (var i = [], n = 0, a = e.emails.length; n < a; ++n) i.push(new ShareRecipient({
            email: e.emails[n]
        }));
        this.containers.invitees = new Container(i, {
            allowDrag: !1
    ...
    LPRequest.makeRequest(LPProxy.inviteFriends, {
        params: t
    })
};
//# sourceMappingURL=sourcemaps/inviteFriendsDialog.js.map