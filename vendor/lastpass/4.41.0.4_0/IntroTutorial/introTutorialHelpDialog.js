...
IntroTutorialHelpDialog.prototype = Object.create(Dialog.prototype), IntroTutorialHelpDialog.prototype.constructor = IntroTutorialHelpDialog,
    function() {
        "use strict";
        IntroTutorialHelpDialog.prototype.blurPreviousDialog = function() {}, IntroTutorialHelpDialog.prototype.focusPreviousDialog = function() {}, IntroTutorialHelpDialog.prototype.setArrowClass = function(t, e) {
            if (e.show) {
                var o = "arrow_box";
                ...
                if (e.positionTarget) {
                    ...
                    switch (e.orientation) {
                        ...
                        case "left":
                        case "right":
                            var n = i.top - a.top + i.height / 2;
                            r.insertRule(".arrow_box.a-top:before, .arrow_box.a-top:after { top: " + n + "px }", r.cssRules.length)
                    }
                }
            ...
            var o;
            Dialog.prototype.initialize.apply(this, arguments), o = this, t.find(".hideButton").bind("click", function() {
                o.close()
            })
            ...
            switch (e.textChoice) {
                case "saveSite":
                    o.text(Strings.translateString("Add site to LastPass")), a.text(Strings.translateString("Simply select 'Add' and we will add %1 to your vault", e.siteName));
                    break;
                case "siteLanding":
            ...
            this.setArrowClass(t, e.arrow), e.parentDialog && dialogs[e.parentDialog].getDialog().addChildDialog(this), e.css && t.css(e.css), e.addHide && t.addClass("allowHide"), e.alignBottom && t.css({
                top: "auto",
                right: "auto",
                bottom: 15,
                left: 30
...
//# sourceMappingURL=sourcemaps/IntroTutorial/introTutorialHelpDialog.js.map