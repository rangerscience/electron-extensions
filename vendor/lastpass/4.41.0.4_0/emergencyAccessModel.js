var EmergencyAccessUserContainer = function(e, t) {
    this.pendingGroup = new SharedSiteGroup(Strings.translateString("Pending"), "pendingFolder"), this.acceptedGroup = new SharedSiteGroup(Strings.translateString("People I Trust"), "acceptedFolder"), this.declinedGroup = new SharedSiteGroup(Strings.translateString("Declined Offers"), "declinedFolder"), Container.call(this, [this.declinedGroup, this.pendingGroup, this.acceptedGroup], t);
    for (var s = 0, r = e.length; s < r; ++s) this.addChild(e[s])
};
EmergencyAccessUserContainer.prototype = Object.create(SharingContainer.prototype), (EmergencyAccessUserContainer.prototype.constructor = EmergencyAccessUserContainer).prototype.addChild = function() {
    var e = function(e) {
        e._model.hasAccepted() ? this.acceptedGroup.addChild(e) : e._model.hasDeclined() ? this.addDeclined(e) : this.pendingGroup.addChild(e)
    };
    return function() {
        this.checkForStateChange(e, arguments)
    }
}(), EmergencyAccessUserContainer.prototype.addDeclined = function() {};
var EmergencyAccessRecipientContainer = function(e, t) {
    EmergencyAccessUserContainer.call(this, e, t)
};
EmergencyAccessRecipientContainer.prototype = Object.create(EmergencyAccessUserContainer.prototype), (EmergencyAccessRecipientContainer.prototype.constructor = EmergencyAccessRecipientContainer).prototype.addDeclined = function(e) {
    this.declinedGroup.addChild(e)
};
var EmergencyAccessSharerContainer = function(e, t) {
    EmergencyAccessUserContainer.call(this, e, t), this.acceptedGroup._model._data.group = Strings.translateString("People Who Trust Me")
};
EmergencyAccessSharerContainer.prototype = Object.create(EmergencyAccessUserContainer.prototype), EmergencyAccessSharerContainer.prototype.constructor = EmergencyAccessSharerContainer,
    function() {
        var t = function() {
        ...
        }, EmergencyAccessUser.prototype = Object.create(VaultItemBase.prototype), EmergencyAccessUser.prototype.constructor = EmergencyAccessUser, EmergencyAccessUser.prototype.refresh = function(e) {
            return VaultItemBase.prototype.refresh.call(this, e), t.call(this), this
        }
    }(), EmergencyAccessUser.prototype.getName = function() {
        return this._data.username
    }, EmergencyAccessUser.prototype.getID = EmergencyAccessUser.prototype.getName, EmergencyAccessUser.prototype.getFormData = function(e) {
...
var EmergencyAccessUserDisplay = function(e) {
    VaultItemBaseDisplay.call(this, e)
};
EmergencyAccessUserDisplay.prototype = Object.create(VaultItemBaseDisplay.prototype), (EmergencyAccessUserDisplay.prototype.constructor = EmergencyAccessUserDisplay).prototype.buildItemInfoTextElements = function() {
    var e = VaultItemBaseDisplay.prototype.buildItemInfoTextElements.apply(this, arguments),
        t = [];
    return this._model.hasRequestedAccess() ? (Date.now() < this._model._data.override_date ? t.push(LPTools.createElement("p", "small infoLabel", Strings.Vault.ACCESS_PENDING)) : t.push(LPTools.createElement("p", "small infoLabel", Strings.Vault.ACCESS_GRANTED)), t.push(this.createTextElement("p", this.getAccessDate, "small"))) : (t.push(LPTools.createElement("p", "small infoLabel", Strings.Vault.WAITING_PERIOD)), t.push(this.createTextElement("p", this.getHoursAsString, "small"))), e.push(this.buildItemInfoTextElement(t)), e
    ...
    return e = 0 === e ? Strings.translateString("Immediately") : e < 72 ? Strings.translateString("%1 hours", e) : Strings.translateString("%1 days", parseInt(e / 24))
...
}, EmergencyAccessRecipient.prototype = Object.create(EmergencyAccessUser.prototype), EmergencyAccessRecipient.prototype.constructor = EmergencyAccessRecipient, EmergencyAccessRecipient.prototype.getDisplayClass = function() {
    ...
    return function() {
        LPRequest.makeRequest(LPProxy.revokeEmergencyAccessOffer, {
            ...
            confirm: {
                ...
                text: Strings.translateString("Are you sure you want to revoke emergency access for %1?", this.getName())
            }
        })
    }
}(), EmergencyAccessRecipient.prototype.add = function() {
    var e = function() {
        Topics.get(Topics.EMERGENCY_RECIPIENT_ADDED).publish(this), Topics.get(Topics.SUCCESS).publish(Strings.translateString("Invitation sent."))
    };
    return function() {
...
var EmergencyAccessRecipientDisplay = function(e) {
    EmergencyAccessUserDisplay.call(this, e)
};
EmergencyAccessRecipientDisplay.prototype = Object.create(EmergencyAccessUserDisplay.prototype), (EmergencyAccessRecipientDisplay.prototype.constructor = EmergencyAccessRecipientDisplay).prototype.getItemButtonActions = function() {
    return this._model.hasAccepted() ? [Constants.ACTION_EDIT, Constants.ACTION_REVOKE] : [Constants.ACTION_EDIT, Constants.ACTION_EMAIL, Constants.ACTION_CANCEL]
    ...
    return this._model.hasAccepted() ? t.push(new LPTools.ContextMenuItem(Constants.ACTION_REVOKE)) : (t.push(new LPTools.ContextMenuItem(Constants.ACTION_EMAIL)), t.push(new LPTools.ContextMenuItem(Constants.ACTION_CANCEL))), t
}, EmergencyAccessRecipientDisplay.prototype.createSecondaryNameTextElement = function() {
    if (this._model.isLinked()) {
        var e = LPTools.createElement("p", "small infoLabel", Strings.Vault.LINKED);
        return e.insertBefore(LPTools.createElement("i", "badge danger small"), e.firstChild), e
    }
    return null
}, EmergencyAccessSharer = function(e) {
    EmergencyAccessUser.call(this, e)
}, EmergencyAccessSharer.prototype = Object.create(EmergencyAccessUser.prototype), EmergencyAccessSharer.prototype.constructor = EmergencyAccessSharer, EmergencyAccessSharer.prototype.getDisplayClass = function() {
    ...
    return function() {
        LPRequest.makeRequest(LPProxy.requestEmergencyAccess, {
            ...
            confirm: {
                ...
                text: [Strings.translateString("Emergency Access should only be requested if there is a valid emergency situation and you need to manage another user's vault."), Strings.translateString("Are you sure you want to continue?")]
            }
        })
    }
}(), EmergencyAccessSharer.prototype.unlinkAccount = function() {
    var e = function() {
        Topics.get(Topics.SUCCESS).publish(Strings.translateString("Account (%1) unlinked.", this.getName())), Topics.get(Topics.REFRESH_DATA).publish()
    };
    return function() {
        LPRequest.makeRequest(LPProxy.unlinkEmergencyAccessAccount, {
            params: {
                email: this.getName()
            },
            success: this.createHandler(e)
    ...
    var e = function(e) {
        this.update(e), Topics.get(Topics.SUCCESS).publish(Strings.translateString("Accepted")), Topics.get(Topics.UPDATE_NOTIFICATION_COUNT).publish()
    };
    return function() {
    ...
    var e = function() {
        Topics.get(Topics.UPDATE_NOTIFICATION_COUNT).publish(), Topics.get(Topics.SUCCESS).publish(Strings.translateString("Declined")), this.deleteUpdates(!1)
    };
    return function() {
        LPRequest.makeUpdateRequest(LPProxy.declineEmergencyAccessOffer, {
            ...
            confirm: {
                ...
                text: Strings.translateString("Are you sure you want to decline to be the emergency access contact for %1?", this.getName())
            }
        })
    }
}();
var EmergencyAccessSharerDisplay = function(e) {
    EmergencyAccessUserDisplay.call(this, e)
};
EmergencyAccessSharerDisplay.prototype = Object.create(EmergencyAccessUserDisplay.prototype), (EmergencyAccessSharerDisplay.prototype.constructor = EmergencyAccessSharerDisplay).prototype.getLaunchElementAction = function() {
    var e = null;
    return this._model.hasAccepted() ? this._model.isLinked() ? e = Constants.ACTION_UNLINK : this._model.hasRequestedAccess() || (e = Constants.ACTION_ACCESS) : e = Constants.ACTION_ACCEPT, e
    ...
    return this._model.hasAccepted() ? this._model.isLinked() ? t.unshift(new LPTools.ContextMenuItem(Constants.ACTION_UNLINK, {
        text: Strings.Vault.UNLINK
    })) : t.unshift(new LPTools.ContextMenuItem(Constants.ACTION_ACCESS)) : t.unshift(new LPTools.ContextMenuItem(Constants.ACTION_ACCEPT)), t
}, EmergencyAccessSharerDisplay.prototype.createSecondaryNameTextElement = function() {
    if (this._model.isLinked()) {
        var e = LPTools.createElement("p", "small infoLabel", Strings.Vault.LINKED);
        return e.insertBefore(LPTools.createElement("i", "badge success small"), e.firstChild), e
    }
    return null
