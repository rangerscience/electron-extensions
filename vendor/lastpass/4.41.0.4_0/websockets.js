...
function lp_ws_lib() {
    ...
    function a(e) {
        console.info("WS CONNECTED"), lpnp_init(), ws_send_message({
    ...
    this.setup = function(e) {
        ...
        lpnp_notify("internal_logincheck"), setTimeout(function() {
            g_np_gotack || httptest()
        }, 3e3)
    }
}
lp_ws = lp_ws || new lp_ws_lib;
//# sourceMappingURL=sourcemaps/websockets.js.map