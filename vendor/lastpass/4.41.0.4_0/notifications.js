    ...
    var t = null,
        ...
        i = function(e, t) {
            ...
            if (t) {
                ...
                s = i.text(), "string" == typeof t ? "" != s ? i.text(s + "   " + Strings.translateString(t)) : i.text(Strings.translateString(t)) : t instanceof Array && (i.empty(), i.append(t)), e.css("top", 0)
            }
        },
        n = function(e) {
            i(t, e)
        ...
        r = null,
        c = function(e) {
            i(s, e), clearTimeout(r), r = setTimeout(function() {
                l()
            }, 3e3)
        },
        g = function(e) {
            var t = ["notification"].concat(LPTools.getOption(e, "additionalClasses", [])),
                ...
                i = "undefined" != typeof dialogs && void 0 !== dialogs.baseURL ? dialogs.baseURL : "",
                n = LPTools.createElement("div", "messageCell");
            n.appendChild(LPTools.createElement("img", {
                src: i + e.img
            })), n.appendChild(LPTools.createElement("span", "title", e.title)), n.appendChild(LPTools.createElement("span", "message")), s.appendChild(n);
            var o = LPTools.createElement("div", {
                class: "close midToneHover",
                title: Strings.translateString("Close")
            });
            return o.appendChild(LPTools.createElement("img", {
                src: i + e.closeImg
            })), LPPlatform.addEventListener(o, "click", e.closeHandler), s.appendChild(o), document.body.appendChild(s), $(s)
        },
        e;
    return {
        displayErrorMessage: n,
        displaySuccessMessage: c,
        initialize: function(e) {
            t = g($.extend(e, {
                ...
                closeImg: "images/vault_4.0/Success_Close.png",
                closeHandler: l
