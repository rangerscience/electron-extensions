...
CreditMonitoringContainer.prototype = Object.create(Container.prototype), (CreditMonitoringContainer.prototype.constructor = CreditMonitoringContainer).prototype.initialize = function(t) {
    t = $(t), this.buildItems(this._items, t.find(".profiles").get(0), this._buildOptions), this.buildItems(this.alerts, t.find(".alerts").get(0), $.extend({}, this._buildOptions, {
        sortFunction: CreditMonitoringAlert.prototype.sortByDateDesc
    }))
...
var CreditMonitoringProfile = function(t) {
...
CreditMonitoringProfile.prototype = Object.create(VaultItemBase.prototype), $.extend(CreditMonitoringProfile.prototype, VaultItemBaseDisplay.prototype), (CreditMonitoringProfile.prototype.constructor = CreditMonitoringProfile).prototype.getID = function() {
    ...
    e.appendChild(this.createTextElement("td", this.getID)), e.appendChild(this.createTextElement("td", this.getEnabledDate)), e.appendChild(this.createTextElement("td", this.getStatus));
    var r = LPTools.createElement("td");
    return e.appendChild(r), this.isPremium() ? r.appendChild(LPTools.createElement("a", {
        class: "creditProfileAction",
        vaultaction: Constants.ACTION_DASHBOARD
    }, "Dashboard")) : r.appendChild(LPTools.createElement("a", {
        class: "creditProfileAction",
        vaultaction: Constants.ACTION_UPGRADE
    }, "Upgrade")), e
}, CreditMonitoringProfile.prototype.getContextMenuItems = function(t) {
    return this.isPremium() ? [new LPTools.ContextMenuItem(Constants.ACTION_DASHBOARD)] : [new LPTools.ContextMenuItem(Constants.ACTION_UPGRADE)]
    ...
    var t = "undefined" != typeof chrome && (void 0 !== chrome.runtime || void 0 !== chrome.extension) && -1 != navigator.userAgent.indexOf(" Firefox/"),
    ...
    if (t || e) {
        ...
        $.ajax({
            ...
            timeout: 2e4,
            success: function(t) {
                "" !== t ? bg.openURL(t) : dialogs.alert.open({
            ...
            error: function(t, e) {
                var r = [];
                r = 404 === t.status ? ["We couldn't find this user in the credit monitoring database", "Please register at least one Credit Monitoring Form Fill"] : 400 === t.status ? ["You don't have LastPass Premium Credit Monitoring.", "Please upgrade to LastPass Premium Credit Monitoring to use the Credit Monitoring Dashboard."] : ["Unexpected error happen, please contact LastPass Support"], dialogs.alert.open({
                    title: Strings.translateString("Error"),
                    text: r
                })
            }
        })
    } else LPProxy.callAcctsIFrameCommand("opencreditmondashnoalert", this.getID())
}, CreditMonitoringProfile.prototype.upgrade = function() {
    bg.openURL(LPProxy.getBaseURL() + "features_joinpremium_creditmon.php")
};
var CreditMonitoringAlert = function(t) {
    VaultItemBase.call(this, t), VaultItemBaseDisplay.call(this, this)
};
CreditMonitoringAlert.prototype = Object.create(VaultItemBase.prototype), $.extend(CreditMonitoringAlert.prototype, VaultItemBaseDisplay.prototype), (CreditMonitoringAlert.prototype.constructor = CreditMonitoringAlert).prototype.getID = function() {
    ...
    var e = LPTools.createElement("tr");
    e.appendChild(this.createTextElement("td", this.getDate)), e.appendChild(this.createTextElement("td", this.getProfileID)), e.appendChild(this.createTextElement("td", this.getMessage));
    var r = LPTools.createElement("td");
    return r.appendChild(LPTools.createElement("a", {
        class: "creditProfileAction",
        vaultaction: Constants.ACTION_DELETE
    }, "Delete")), e.appendChild(r), e
    ...
    var t;
    t = this, LPRequest.makeRequest(LPProxy.deleteCreditMonitoringAlert, {
        parameters: t.getID(),
        success: function() {
            t.deleteUpdates()
        },
...
//# sourceMappingURL=sourcemaps/creditModel.js.map