PreferencesAsync = {
    ...
    get: function(e, o, t) {
        var r;
        t(Preferences.get(e, o))
    }
}, Preferences = function() {
    var r = {},
        n = function(e, o) {
            var t = LPPlatform.getPreference(e);
            if (o = void 0 === o ? i[e] : o, void 0 === t) return o;
            if (typeof t != typeof i[e]) switch (typeof i[e]) {
                case "boolean":
                    return "true" === t || 1 === parseInt(t);
                case "number":
                    return t = -1 === t.indexOf(".") ? parseInt(t) : parseFloat(t), isNaN(t) ? o : t;
                case "object":
                    return JSON.parse(t)
            }
            return t
    ...
    LPPlatform.adjustPreferenceDefaults(i), LPPlatform.isMac() ? (i.generateHkKeyCode = 0, i.generateHkMods = "", i.recheckHkKeyCode = 0, i.recheckHkMods = "", i.searchHkKeyCode = 76, i.searchHkMods = "shift meta", i.nextHkKeyCode = 33, i.nextHkMods = "meta", i.prevHkKeyCode = 34, i.prevHkMods = "meta", i.homeHkKeyCode = 0, i.homeHkMods = "", i.openpopoverHkKeyCode = 220, i.openpopoverHkMods = "meta") : (i.generateHkKeyCode = 71, i.generateHkMods = "alt", i.recheckHkKeyCode = 73, i.recheckHkMods = "alt", i.searchHkKeyCode = 87, i.searchHkMods = "alt", i.nextHkKeyCode = 33, i.nextHkMods = "alt", i.prevHkKeyCode = 34, i.prevHkMods = "alt", i.homeHkKeyCode = 72, i.homeHkMods = "control alt", i.openpopoverHkKeyCode = 220, i.openpopoverHkMods = "alt");
    var l = function(e, o) {
        var t;
        LPPlatform.setUserPreference(e, o), s[e] && LPPlatform.setGlobalPreference(e, o), (r[e] || []).forEach(function(e) {
            e(o)
        })
    };
    return {
        ...
        get: function(e, o) {
            switch (typeof e) {
                case "object":
                    var t = {};
                    for (var r in e) t[r] = n(r, o ? o[r] : void 0);
                    return t;
                case "string":
                    return n(e, o);
                default:
