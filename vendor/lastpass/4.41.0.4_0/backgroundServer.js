    ...
    return {
        emergencyAccess: {
            ...
            requestAccess: function(e) {
                ...
                var n = e.callbacks.successGranted;
                e.callbacks.successGranted = function(e, s) {
                    var r = s.params.sharer;
                    r.confirmed = "1", r.override_date = new Date, r.override_date.setTime(r.override_date.getTime() + 60 * r.hours_to_override * 60 * 1e3), n && n(r, s)
            ...
            unlinkAccount: function(r) {
                r.success = LPServer.extendCallback(r.success, s(function() {
            ...
            updateShareeKey: function(e, s) {
                ...
                LPServer.emergencyAccess.updateShareeKey(r)
            }
        },
        identities: {
            add: function(r) {
        ...
        sharing: {
            ...
            folder: {
                ...
                create: function(e) {
                    e.success = LPServer.extendCallback(e.success, s(function(e, s) {
                        s.shareInfo.sharekeyaes = lpmenc(AES.bin2hex(s.shareInfo.key), !0, g_local_key), s.sharedFolder.sharefolderid = s.sharedFolder.aid, r(s.shareInfo, g_shares, "id"), r(s.sharedFolder, g_sites, "aid")
                    })), e.params.username = g_username, LPServer.sharing.folder.create(e)
                },
                rename: function(e) {
                    e.success = LPServer.extendCallback(e.success, s(function(e, s) {
                ...
                reject: function(e) {
                    e.success = LPServer.extendCallback(e.success, s(function() {
        ...
        sitesAndNotes: {
            ...
            deleteCustomNoteTemplate: function(r) {
                r.success = LPServer.extendCallback(r.success, s(function(e, s) {
        ...
        families: {
            ...
            getInvitations: function(e) {
                LPServer.lmiapi.jsonRequest({
                    url: "lmiapi/families/invitations",
                    type: "GET",
                    success: e.success,
                    userSupplied: e
                })
...
//# sourceMappingURL=sourcemaps/backgroundServer.js.map