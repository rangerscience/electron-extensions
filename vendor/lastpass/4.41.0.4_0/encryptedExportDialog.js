...
EncryptedExportDialog.prototype = Object.create(Dialog.prototype), (EncryptedExportDialog.prototype.constructor = EncryptedExportDialog).prototype.initialize = function(t) {
    ...
    t.find(".showPassword").on("click", function() {
        ...
        return i ? !(i.length < 12 || -1 === i.search(/^(?=.*[A-Z])(?=.*[a-z])(?=.*[0-9]).+$/)) || (t.addError(e, Strings.translateString("Your key's not strong enough! Minimum requirements: 12 characters, 1 number, 1 uppercase & 1 lowercase letter.")), !1) : (t.addError(e, Strings.translateString("Required!")), !1)
    }, this.inputFields.confirmKey.validate = function(t, e, i) {
        return i === t.validateOptions.data.encryptionKey || (t.addError(e, Strings.translateString("Key and confirmation don't match!")), !1)
    }
    ...
    if ("function" == typeof this.data.callback) {
        var e = this.getData();
        this.data.callback(this.valid, e.encryptionKey)
    }
    Dialog.prototype.close.call(this, t)
};
//# sourceMappingURL=sourcemaps/encryptedExportDialog.js.map