    ...
    return t.prototype.setup = function() {
        if (this.options.$parentEl) {
            ...
            for (var t = 0; t < this.options.steps.length; t++) {
                ...
                i && (this.options.steps[t].ping = new p({
        ...
        for (var i = 0; i < this.options.steps.length; i++) i < t ? this.hide(this.options.steps[i]) : (this.show(this.options.steps[i]), this.deActivate(this.options.steps[i]));
...
//# sourceMappingURL=sourcemaps/Tour/lpPingManager.js.map