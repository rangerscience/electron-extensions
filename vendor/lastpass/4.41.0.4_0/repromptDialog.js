...
RepromptDialog.prototype = Object.create(Dialog.prototype), RepromptDialog.prototype.constructor = RepromptDialog,
    function() {
        var t = Strings.translateString("Invalid Password.");
        RepromptDialog.prototype.initialize = function(t) {
            "undefined" != typeof lpFederatedLoginObj && lpFederatedLoginObj.wasLastLoginFederated() && (this.options.hideButtons = !0), Dialog.prototype.initialize.call(this, t)
            ...
            Dialog.prototype.preSetup.call(this, t), "undefined" != typeof lpFederatedLoginObj && lpFederatedLoginObj.wasLastLoginFederated() && (document.getElementById("reprompt-master-password").style.display = "none", document.getElementById("reprompt-federated").style.display = "block")
        }, RepromptDialog.prototype.postSetup = function(t) {
            Dialog.prototype.postSetup.call(this, t);
            var e = this;
            "undefined" != typeof lpFederatedLoginObj && lpFederatedLoginObj.wasLastLoginFederated() && setTimeout(function() {
            ...
            this.numfailed < 2 ? (this.numfailed++, this.addError("password", t), this.postValidate(!1), this.inputFields.password.focus()) : this.close()
        }, RepromptDialog.prototype.validateReprompt = function(t) {
            if ("function" != typeof this.data.validate) throw "Must override RepromptDialog.prototype.validate or pass a validate callback to dialogs.reprompt.open().";
            this.data.validate(t)
        }, RepromptDialog.prototype.performValidate = function(t) {
            this.validateOptions = t, this.clearErrors(), LPRequest.makeRequest(this.createDynamicHandler(function(t) {
                t.repromptFailed = this.createDynamicHandler(function() {
                    if ("undefined" != typeof lpFederatedLoginObj && lpFederatedLoginObj.wasLastLoginFederated()) return document.querySelector(".loading-gif").classList.add("is-hidden"), document.querySelector(".login-text").classList.add("is-hidden"), document.querySelector(".login-error").classList.add("is-visible"), void document.querySelector(".error-text").classList.add("is-visible");
                    this.error(), t.error("")
                }), this.validateReprompt(t)
            }), {
                params: t.data,
                success: this.createDynamicHandler(this.success)
            })
        }
    }();
