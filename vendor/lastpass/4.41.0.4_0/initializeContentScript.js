...
(function() {
    ...
    var e = [],
        ...
        n = function() {
            t = function(t) {
                t()
            }, e.forEach(t), Topics.get(Topics.INITIALIZED).publish()
        };
    ...
    }), window === top ? csTop = Interfaces.createInstance(Interfaces.ContentScriptInterface, {
        context: "contentScript",
        direct: !0,
        source: this
...
//# sourceMappingURL=sourcemaps/initializeContentScript.js.map