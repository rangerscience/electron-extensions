! function(n) {
    ...
    n.extend(n.tree.plugins, {
        hotkeys: {
            ...
            exec: function(e) {
                if (n.tree.plugins.hotkeys.disabled) return !1;
                var t = n.tree.focused();
                if (void 0 !== t.settings.plugins.hotkeys) {
                    var s = n.extend(!0, {}, n.tree.plugins.hotkeys.defaults, t.settings.plugins.hotkeys);
                    return "function" == typeof s.functions[e] ? s.functions[e].apply(t) : void 0
                }
            },
            get_next: function() {
            ...
            callbacks: {
                oninit: function(e) {
                    ...
                    for (var s in t.functions) t.functions.hasOwnProperty(s) && -1 == n.inArray(s, n.tree.plugins.hotkeys.bound) && (function(t) {
                        n(document).bind("keydown", {
                            combi: t,
                            disableInInput: !0
                        }, function(e) {
                            return n.tree.plugins.hotkeys.exec(t)
                        })
                    }(s), n.tree.plugins.hotkeys.bound.push(s))
                }
            }
        }
    })
}(jQuery);
//# sourceMappingURL=sourcemaps/jquery.tree.hotkeys.js.map