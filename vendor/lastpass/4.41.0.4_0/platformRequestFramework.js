LPPlatform = "undefined" == typeof LPPlatform ? {} : LPPlatform,
    function(r) {
        var n;
        r.requestFrameworkInitializer = (n = function(e, n) {
            var s = e("", {
                name: "requestPort"
            });
            return s.onMessage.addListener(n),
                function(e) {
                    s.postMessage(e)
                }
        }, function(e) {
            ...
            var n = getBG();
            n.Preferences.set("native_messaging_asked", "1"), e ? window.open("/native_messaging.html?hidenever=1") : void 0 !== chrome.permissions && chrome.permissions.request({
