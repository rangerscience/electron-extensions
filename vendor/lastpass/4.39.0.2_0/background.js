...
var IntroTutorial = function() {
  ...
  function n() {
    e && t && (t = e = !1, LPContentScriptFeatures.safari_legacy_messaging ? LPPlatform.openTab({
      ...
      else if (LPContentScriptFeatures.icob && Preferences.get("showIntroTutorial"))
        if (i(e)) b(e.tabID);
        else if (o(e)) {
        var t = e.tabURL;
  ...
  function _() {
    LPContentScriptFeatures.icob && r.isInContext ? setTimeout(function() {
      get_selected_tab(null, function(e) {
        var t = gettabid(e);
        d(e.url) ? LPTabs.get({
          tabID: t
