const initNewRelic = function() {
        window.NREUM || (NREUM = {}), __nr_require = function(t, e, n) {
            ...
            2: [function(t, e, n) {
                function r(t, e, n, r, c) {
                    try {
                        h ? h -= 1 : i(c || new o(t, e, n), !0)
                    } catch (t) {
                        try {
                            a("ierr", [t, f.now(), !0])
                        } catch (t) {}
                    }
                    return "function" == typeof d && d.apply(this, s(arguments))
                }
                ...
                try {
                    ...
                    "stack" in e && (t(13), t(12), "addEventListener" in window && t(6), f.xhrWrappable && t(14), l = !0)
                }
                c.on("fn-start", function(t, e, n) {
                    l && (h += 1)
                }), c.on("fn-err", function(t, e, n) {
                    l && !n[p] && (u(n, p, function() {
                        return !0
                    }), this.thrown = !0, i(n))
                }), c.on("fn-end", function() {
                    l && !this.thrown && h > 0 && (h -= 1)
            ...
            4: [function(t, e, n) {
                ...
                if (w[v] && x.xhrWrappable) {
                    ...
                    var M, S = 0;
                    N.on(u, r), N.on(l, r), N.on(d, o), N.on(p, o), N.buffer([u, d, "xhr-done", "xhr-resolved"]), R.buffer([u]), C.buffer(["setTimeout" + c, "clearTimeout" + s, u]), O.buffer([u, "new-xhr", "send-xhr" + s]), T.buffer([m + s, m + "-done", m + f + s, m + f + c]), E.buffer(["newURL"]), g.buffer([u]), b.buffer(["propagate", l, p, "executor-err", "resolve" + s]), L.buffer([u, "no-" + u]), P.buffer(["new-jsonp", "cb-start", "jsonp-error", "jsonp-end"]), a(O, "send-xhr" + s), a(N, "xhr-resolved"), a(N, "xhr-done"), a(T, m + s), a(T, m + "-done"), a(P, "new-jsonp"), a(P, "jsonp-end"), a(P, "cb-start"), E.on("pushState-end", i), E.on("replaceState-end", i), w[v]("hashchange", i, !0), w[v]("load", i, !0), w[v]("popstate", function() {
                        i(0, S > 1)
                    }, !0)
                }
            }, {}],
            5: [function(t, e, n) {
                ...
                if (window.performance && window.performance.timing && window.performance.getEntriesByType) {
                    ...
                    var g = NREUM.o.EV;
                    o.on(m, function(t, e) {
                        t[0] instanceof g && (this.bstStart = x.now())
                    }), o.on(v, function(t, e) {
                        var n = t[0];
            ...
            9: [function(t, e, n) {
                function r(t) {
                    function e() {
                        c.emit("jsonp-end", [], a), t.removeEventListener("load", e, !1), t.removeEventListener("error", n, !1)
                    }

                    function n() {
                        c.emit("jsonp-error", [], a), c.emit("jsonp-end", [], a), t.removeEventListener("load", e, !1), t.removeEventListener("error", n, !1)
                    }
                    if (t && "string" == typeof t.nodeName && "script" === t.nodeName.toLowerCase()) {
                        if ("function" == typeof t.addEventListener) {
                            ...
                            if (r) {
                                var o = s(r);
                                if ("function" == typeof o.parent[o.key]) {
                                    var a = {};
                                    f.inPlace(o.parent, [o.key], "cb-", a), t.addEventListener("load", e, !1), t.addEventListener("error", n, !1), c.emit("new-jsonp", [t.src], a)
                                }
                            }
                        }
                    }
                ...
                if (e.exports = c, o()) {
                    ...
                    f.inPlace(HTMLElement.prototype, p, "dom-"), f.inPlace(HTMLHeadElement.prototype, p, "dom-"), f.inPlace(HTMLBodyElement.prototype, p, "dom-"), c.on("dom-start", function(t) {
                        r(t[0])
                    })
                }
            }, {}],
            ...
            14: [function(t, e, n) {
                ...
                var g = window.XMLHttpRequest = function(t) {
                    ...
                    try {
                        ...
                        try {
                            u.emit("internal-error", [t])
                        } catch (t) {}
                    }
                    return e
                };
                if (c(p, g), g.prototype = p.prototype, d.inPlace(g.prototype, ["open", "send"], "-xhr-", s), u.on("send-xhr-start", function(t, e) {
                        r(t, e), i(e)
                    ...
                    s.features.xhr = !0, t(14), d.on("new-xhr", function(t) {
                        ...
                        this.startTime = s.now(), this.listener = function(t) {
                            try {
                                ...
                                try {
                                    d.emit("internal-error", [t])
                                } catch (t) {}
                            }
                        };
                        for (var a = 0; a < p; a++) e.addEventListener(l[a], this.listener, !1)
            ...
            21: [function(t, e, n) {
                function r() {
                    ...
                    for (var o, i = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx", a = "", s = 0; s < i.length; s++) "x" === (o = i[s]) ? a += t().toString(16) : "y" === o ? a += (o = 3 & t() | 8).toString(16) : a += o;
                    return a
                }
            ...
            22: [function(t, e, n) {
                ...
                if (navigator.userAgent) {
                    var s = navigator.userAgent,
                        c = s.match(a);
                    c && -1 === s.indexOf("Chrome") && -1 === s.indexOf("Chromium") && (o = "Safari", i = c[1])
                }
                e.exports = {
                    agent: o,
                    version: i,
                    ...
                    function n(t, e, n, o) {
                        function s() {
                            ...
                            try {
                                ...
                                throw u(e + "err", [r, a, t], s), t
                            } finally {
                                u(e + "end", [r, a, c], s)
                            }
                        }
                        return r(t) ? t : (e || (e = ""), s[a] = t, d(t, s), s)
                    }

                    function f(t, e, o, i) {
                        o || (o = "");
                        var a, s, c, f = "-" === o.charAt(0);
                        for (c = 0; c < e.length; c++) r(a = t[s = e[c]]) || (t[s] = n(a, f ? s + o : o, i, s))
                    }
            ...
            loader: [function(t, e, n) {
                ...
                var y = "" + location,
                    x = {
                        ...
                        agent: "js-agent.newrelic.com/nr-spa-1123.min.js"
                    },
        ...
        NREUM.info = {
            ...
            applicationID: "269135848",
            sa: 1
        }
    },
    NEW_RELIC_GATE_PERCENT = .01;
Math.random() < NEW_RELIC_GATE_PERCENT && initNewRelic();
