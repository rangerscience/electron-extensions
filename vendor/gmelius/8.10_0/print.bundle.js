            ...
            if (e.enabled) {
                ...
                document.addEventListener("DOMContentLoaded", function(e) {
                    var n = document.getElementsByTagName("table"),
                        r = document.getElementsByTagName("hr"),
                        a = (document.getElementsByTagName("img"), document.evaluate('//font[@size=-1 and .="1 message"]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null));
                    (t.smart || t.business || t.graphic) && (n && n[0].parentNode.removeChild(n[0]), r && (r[r.length - 1].parentNode.removeChild(r[r.length - 1]), r[0].parentNode.removeChild(r[0])), (t.business || t.graphic) && (n[1].deleteRow(0), n[1].deleteRow(0)), t.graphic && n[0].deleteRow(0), a && a.singleNodeValue.parentNode.removeChild(a.singleNodeValue))
                })
            }
        }(JSON.parse(window.localStorage.getItem("gmelius:print")))
    }
});
